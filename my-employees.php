...
$sql = 'INSERT INTO `customer_employee_data`(`customer_employee_id`, `user_id`, `user_date`, `owner_id`, `name`, `phone`, `email`, `address`, `nic`, `picture`, `comments`,`salary`,attendance_id) VALUES (NULL,\'';
$sql .= get_curr_user();
$sql .= '\', CURRENT_TIMESTAMP, \''.get_curr_user().'\', \''.$_REQUEST['name'].'\', \''.$_REQUEST['phone'].'\', \''.$_REQUEST['email'].'\', \''.$_REQUEST['address'].'\', \''.$nic.'\', \''.$Picture.'\', \''.$_REQUEST['comments'].'\', \''.$_REQUEST['salary'].'\', \''.$_REQUEST['attendance_id'].'\')';
            ...
            <div class="wrapper">
                <div class="container">
                    ...
                    if (isset($_GET['specific'])) { 
                        $sql_employee = 'SELECT `customer_employee_id`, `user_id`, `user_date`, `owner_id`, `name`"Name", `phone`, `email`, `address`, `nic`, `picture`, `comments`,`salary`"Salary",attendance_id "Attacdance ID" FROM `customer_employee_data` WHERE `customer_employee_id` = '.$_GET['specific'].'';
                ...
                <div class="col-lg-12">
                    <div class="card-box">
                        ...
                        <form action="my-employees.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="">Attendance ID (If you have id of employee of attendance machine) optinal</label>
                                <input type="number" name="attendance_id" placeholder="Enter attendance id" class="form-control" value="<?php if(isset($_REQUEST['attendance_id'])) echo $_REQUEST['attendance_id']?>">
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
